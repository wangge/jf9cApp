...
$(function() {
    ...
    $('#show_style').click(function(){
        ...
        if ($(product_content_obj).hasClass('list')) {
            $(this).find('span').removeClass('browse-list').addClass('browse-grid');
            $(product_content_obj).removeClass('list').addClass('grid');
        } else {
            $(this).find('span').addClass('browse-list').removeClass('browse-grid');
            $(product_content_obj).addClass('list').removeClass('grid');
        }
    });
    ...
    $('#product_list').on('click', '[wt_type="goods_more_link"]',function(){
        ...
        $.ajax({
            type: 'post',
            url: MapiUrl + "/index.php?w=member_favorites&t=favorites_info",
...
function get_list(change_param, is_init){
    ...
    load_class_storegoodslist.loadInit({
        'url':MapiUrl + '/index.php?w=store&t=store_goods',
        'getparam':param,
        'tmplid':'goods_list_tpl',
        'containerobj':$("#product_list"),
        data:{key_a:order_key, order:order_val},
        'iIntervalId':true,
        callback:function(){
            isload_goods = false;
        }
