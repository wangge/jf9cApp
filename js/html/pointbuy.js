...
$(function() {
    ...
    var _init = function(e) {
        ...
        $.ajax({
            type: "post",
            url: MapiUrl + "/index.php?w=pointcart&t=step1",
            dataType: "json",
            data: {
                key: key,
                cart_id: cart_id,
            ...
            success: function(e) {
                ...
                e.datas.pointprod_arr.MUrl = MUrl;
    ...
    $("#ToBuyStep2").click(function() {
        ...
        $.ajax({
            type: "post",
            url: MapiUrl + "/index.php?w=pointcart&t=step2",
            data: {
                key: key,
            ...
            success: function(e) {
                ...
                setTimeout(function () {
                  window.location.href = "../member/pointorder_list.html";
                }, 2000);
