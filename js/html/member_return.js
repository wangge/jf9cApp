$(function(){
    ...
    load_class.loadInit({
        url:MapiUrl + '/index.php?w=member_return&t=get_return_list',
        getparam:{key :key },
        ...
        callback:function(){
            $('.delay-btn').click(function(){
                ...
                $.getJSON(MapiUrl+'/index.php?w=member_return&t=delay_form', {key:key,return_id:return_id}, function(result){
                    ...
                    $.sDialog({
                        ...
                        okFn:function(){
                            $.ajax({
                                type:'post',
                                url:MapiUrl+'/index.php?w=member_return&t=delay_post',
