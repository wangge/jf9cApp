...
$(function(){
    ...
    function initPage(){
        ...
        $.ajax({
            type:'post',
            url:MapiUrl+"/index.php?w=seller_order&t=order_vr_list&page="+page+"&curpage="+curpage,
            ...
            success:function(result){
                ...
                data.key = $api.getStorage('seller_key');
    ...
    function cancelOrderId(order_id) {
        $.ajax({
            type:"post",
            url:MapiUrl+"/index.php?w=seller_order&t=order_cancel",
    ...
    function evaluationOrder() {
        ...
        location.href =  '../member/member_evaluation.html?order_id=' + orderId;
    ...
    function evaluationAgainOrder() {
        var orderId = $(this).attr('order_id');
        location.href = '../member/member_evaluation_again.html?order_id=' + orderId;
    }

    function viewOrderDelivery() {
        var orderId = $(this).attr('order_id');
        location.href =  '../member/order_delivery.html?order_id=' + orderId;
    }
