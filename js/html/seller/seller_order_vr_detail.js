$(function() { 
	var r = $api.getStorage("seller_key");
    if (!r) {
        window.location.href= '../member/login.html';
    }
    $.getJSON(MapiUrl + "/index.php?w=seller_order&t=order_info", {
        key: r,
        order_id: getQueryString("order_id")
    },
    function(t) {
        t.datas.order_info.MUrl = MUrl;
        ...
        $.ajax({
            type: "post",
            url: MapiUrl + "/index.php?w=seller_order&t=get_current_deliver",
            data: {
                key: r,
                order_id: getQueryString("order_id")
            },
    ...
    function o() {
        var r = $(this).attr("order_id");
        location.href =  "order_deliver_send.html?order_id=" + r 
    }
    function i(e) {
        $.ajax({
            type: "post",
    ...
    function d() {
        var r = $(this).attr("order_id");
        location.href = "member_evaluation.html?order_id=" + r
    }
    function a() {
        var r = $(this).attr("order_id");
        location.href = "member_evaluation_again.html?order_id=" + r
    }
    function n() {
        var r = $(this).attr("order_id");
        location.href = "refund_all.html?order_id=" + r
    }
    function l() {
        var r = $(this).attr("order_id");
        location.href = "order_delivery.html?order_id=" + r
    }
    function c() {
        var r = $(this).attr("order_id");
        var e = $(this).attr("order_goods_id");
        location.href = "refund.html?order_id=" + r + "&order_goods_id=" + e
    }
    function _() {
        var r = $(this).attr("order_id");
        var e = $(this).attr("order_goods_id");
        location.href = "return.html?order_id=" + r + "&order_goods_id=" + e
    }
});