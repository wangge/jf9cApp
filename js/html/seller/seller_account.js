$(function() { 
    ...
    $.ajax({
        type: "post",
        url: MapiUrl + "/index.php?w=seller_store&t=store_info",
        data: {
            key: a
        },
        dataType: "json",
...
$('input[name="file"]').ajaxUploadImage({
            url : MapiUrl + "/index.php?w=seller_store&t=file_upload",
            data:{key:a},
    ...
    $(".btn").click(function() {
            ...
            $.ajax({
                type: "post",
                url: MapiUrl + "/index.php?w=seller_store&t=store_edit",
                data: {
                    key: a,
                    store_qq: e,
                    store_ww: r,
                ...
                success: function(a) {
                    if (a&&a.code==200) {
						$.sDialog({
							...
							content: "编辑成功",
							okBtn: true,
							okFn:function(){window.location.href = "seller_account.html";},
							cancelBtn: false
						 }); 
                    } else {
						$.sDialog({
