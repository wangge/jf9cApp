$(function() {
    ...
    function s() {
        $.ajax({
            type: "post",
            url: MapiUrl + "/index.php?w=seller_express&t=get_mylist",
            data: {
				order_id:orderid,
                key: e
            },
            ...
            success: function(ed) {
               ...
               // $("#order_step2").append(template.render("orderstep2", ed.datas));
				...
				//默认发货地址
				 $.ajax({
					type: "post",
					url: MapiUrl + "/index.php?w=seller_express&t=get_defaultexpress",
					data: {
						order_id:orderid,
						key: e
					},
					...
					success: function(f) {
                        ...
                        cancelBtn: false,
                        okFn: function() {
                            window.location.href="seller_address_add.html";
                        }
						});
						return false;
						}
