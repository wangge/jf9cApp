...
$(function() {
    ...
    function t() {
        ...
        $.ajax({
            type: "post",
            url: MapiUrl + "/index.php?w=seller_goods&t=goods_list&page=" + page + "&curpage=" + curpage,
            data: {
                key: e,
                goods_type: t,
                keyword: r,
            ...
            success: function(e) {
                ...
                t.MUrl = MUrl;
                t.MapiUrl = MapiUrl;
                t.key = $api.getStorage("seller_key");
    ...
    function i(r) {
        $.ajax({
            type: "post",
            url: MapiUrl + "/index.php?w=seller_goods&t=goods_unshow",
            data: {
            ...
            success: function(e) { 
                if (e.datas && e.datas == 1) {
                    $.sDialog({
						...
						content: "操作成功",
						okFn: function() {
							window.location.href = "store_goods_list.html";
						}
					})
                } else {
                    $.sDialog({
    ...
    function s(r) {
        $.ajax({
            type: "post",
            url: MapiUrl + "/index.php?w=seller_goods&t=goods_show",
            data: {
                commonids: new Array(r),
                key: e
            },
    ...
    function d(r) {
       $.ajax({
            type: "post",
            url: MapiUrl + "/index.php?w=seller_goods&t=goods_drop",
            data: {
                commonids: new Array(r),
                key: e
            },
    ...
    function c() {
        ...
        location.href = "order_delivery.html?order_id=" + e
    }
