...
$(function(){
    $.getJSON( MapiUrl+'/index.php?w=member_chat&t=get_node_info',{key:key,u_id:t_id,chat_goods_id:chat_goods_id}, function(result){
    ...
    var connentNode = function(data){
        ...
        function connect_node() {
                ...
                function node_send_msg(data){
                    ...
                    if(connect === 1) {
                        $.ajax({
                            type:'post',
                            url:MapiUrl+'/index.php?w=member_chat&t=send_msg',
                            data:data,
                            dataType:'json',
        ...
        $('#chat_msg_log').click(function(){
            $.ajax({
                type:'post',
                url:MapiUrl+'/index.php?w=member_chat&t=get_chat_log&page=50',
        ...
        function _upload_GoodsPic(ret,err,element){
            if (ret) {
              ...
              timeout : 100,
              method : 'post',
              url : MapiUrl + "/index.php?w=member_chat&t=image_send&client=wap",
              data : {
