...
$(function() {
    ...
    $('#send').click(function(){
            ...
            $.ajax({
                type:'post',
                url:MapiUrl+"/index.php?w=member_account&t=modify_password_step2",
    ...
    $('#nextform').click(function(){
        ...
        if (auth_code) {
            $.ajax({
                type:'post',
                url:MapiUrl+"/index.php?w=member_account&t=modify_password_step3",
                ...
                success:function(result){
                    if(result.code == 200){
                    	...
                    	setTimeout("location.href = 'member_password_step2.html'",1000);
                    }else{
                        errorTipsShow('<p>' + result.datas.error + '</p>');
                    }
                }
