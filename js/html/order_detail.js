...
$(function() {
    ...
    $.getJSON(MapiUrl + '/index.php?w=member_order&t=order_info',{key:key,order_id:getQueryString('order_id')}, function(result) {
        ...
        $.ajax({
            type: 'post',
            url: MapiUrl + "/index.php?w=member_order&t=get_current_deliver",
    ...
    function goodsRefund() {
        ...
        location.href = 'refund.html?order_id=' + orderId +'&order_goods_id=' + orderGoodsId;
    }
    // 退货
    function goodsReturn() {
        var orderId = $(this).attr('order_id');
        var orderGoodsId = $(this).attr('order_goods_id');
        location.href = 'return.html?order_id=' + orderId +'&order_goods_id=' + orderGoodsId;
    }
});