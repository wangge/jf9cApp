...
function get_list() {
    ...
    $.getJSON(MapiUrl + '/index.php?w=goods&t=goods_gblist' + window.location.search.replace('?','&'), param, function(result){
    	if(!result) {
    		result = [];
    		result.datas = [];
...
function search_show() {
    $.getJSON(MapiUrl + '/index.php?w=index&t=search_show', function(result) {
    	...
    	$('#search_submit').click(function(){
    		...
    		window.location.href =  'goods_robbuy.html' + queryString;
    	});
