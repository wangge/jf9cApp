...
$(function() {
    ...
    $.getJSON(MapiUrl + '/index.php?w=member_refund&t=refund_all_form',{key:key,order_id:getQueryString('order_id')}, function(result) {
        ...
        $('.btn-l').click(function(){
            ...
            $.ajax({//获取区域列表
                type:'post',
                url:MapiUrl+'/index.php?w=member_refund&t=refund_all_post',
                data:param,
                dataType:'json',
                async:false,
                success:function(result){
                    ...
                    window.location.href = 'member_refund.html';
                }
            });
        });
    });
