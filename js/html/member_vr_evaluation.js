...
$(function() {
    ...
    $.getJSON(MapiUrl + '/index.php?w=member_evaluate&t=vr', {key:key, order_id:order_id}, function(result){
        ...
        $('.btn-l').click(function(){
            ...
            $.ajax({//获取区域列表
                type:'post',
                url:MapiUrl+'/index.php?w=member_evaluate&t=save_vr',
                data:param,
                dataType:'json',
                async:false,
                success:function(result){
                    ...
                    window.location.href = 'order_vr_list.html';
                }
            });
        });
    });
