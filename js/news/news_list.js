...
function get_list() {
	...
	$.getJSON(MapiUrl + "/index.php?w=news_article&t=article_list" + window.location.search.replace("?", "&"), param, function(e) {
		if (!e) {
			e = [];
			e.datas = [];
...
function class_list() {
	...
	$.getJSON(MapiUrl + "/index.php?w=news_article&t=class_list", param, function(e) {
		var r = e.datas;
